...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Previo 5. Leonardo Chagoya", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Model del antebrazo
		model = glm::translate(modelTemp,glm::vec3(2.0f,0.0,0.0)); //antebrazo
		...
		modelTemp2 = modelTemp= model = glm::translate(model, glm::vec3(0.20f, 0.0f, 0.0f));
		...
		//modelo del dedo1
		model = glm::translate(modelTemp, glm::vec3(0.2f, 0.0, 0.0));
		...
		//modelo dedo2
		model = glm::translate(modelTemp, glm::vec3(0.5f, 0.0, 0.0));
