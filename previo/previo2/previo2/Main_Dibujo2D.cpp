...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Dibujo de Primitivas en 2D, dibujo de triangulos con indices", NULL, NULL);
	...
	float vertices[] = {
		// Posiciones          // Colores en RGB
		0.5f,  0.5f, 0.0f,    0.5f,0.7f,1.0f,  // top right
