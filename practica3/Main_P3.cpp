...
//construir la torre de cajas tratando que la cara que se vea de frente sea de diferentes colores
//el número de cajas debe corresponder al numero de letras que tiene mi nombre
// leonardo -> 8 letras dsitribuirlo minimo en 3 niveles, cada nivel tiene que tener una escala distinta
...
/*vista ortogonal no se nota la profundidad de los elementos, en una vista en perspectiva si
...
int main() {
	...
	// vertices que corresponden a cada cara del cubo, adaptados para que se vea en una proyección ortogonal
	//GLfloat vertices[] = {
